  ...
  // ==================== PAPER 1 ====================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Granulocytes", "Stromal cells of the marrow", "Stem cells", "Lymphocytes"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["NAD", "α-Naphthol phosphate", "NADPH", "G6PD"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Liver", "None of these", "Both Liver & Spleen", "Spleen"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Nitrogen", "Chlorine", "Hydrogen", "None of these"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Mounting", "Clearing", "Demineralization", "Dehydration"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Pancreas", "Adrenal gland", "Thymus gland", "Pituitary gland"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Acromegaly", "Goiter", "Beri-beri", "Cretinism"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Thyroid gland", "Adrenal cortex", "Adrenal medulla", "Parathyroid gland"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Market of government securities", "Market of guns", "Bullion market", "Market of pure metals"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["LDL", "Chylomicrons", "HDL", "VLDL"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["RNA", "DNA", "Chromatin", "Nucleoli"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Chemical energy", "Electrical energy", "Heat energy", "Light energy"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Exercise", "Sleeping", "Eating", "Both Exercise & Sleeping"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Trapezius", "All of the above", "Adductor magnus", "Digastric muscle"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Calcium phosphate", "Potassium permanganate", "Sodium thiosulphate", "Potassium nitrate"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["R wave", "Q wave", "T wave", "S wave"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["All of these", "Systolic force", "Cardiac output", "Peripheral resistance"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Eosinophil", "Neutrophil", "Basophil", "Macrophages"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Vasopressin", "Calcitonin", "Parathyroid hormone", "1,25-dihydroxycholecalciferol"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Fluorimetric assay", "All of the above", "Radioimmunoassay (RIA)", "ELISA"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Blood cholesterol", "Blood sugar", "Blood urea", "Blood lipid"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Both animal and vegetable sources", "Synthesis", "Animal sources only", "Vegetable sources only"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Diabetes", "Acute pancreatitis", "Renal failure", "Obesity"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Globulin", "Collagen", "Fibrinogen", "Albumin"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["White blood cell", "Platelets", "Red blood cell", "All of the above"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Calcium bicarbonate", "Sodium bicarbonate", "Calcium sulphate", "Magnesium bicarbonate"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Mitochondria", "Ribosome", "Golgi apparatus", "Lysosomes"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Blood transfusion", "All of the above", "Anopheles mosquito bite", "Transmission through placenta"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Sub-arachnoid", "Extra-dural", "Intra-medullary", "Sub-dural"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Globulin", "Histone", "Albumin", "Glutelin"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Liver", "All of the above", "Spleen", "Gut"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Transistor", "Diode", "Electric cell", "Transformer"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Cysteine, tyrosine", "Arginine, histidine", "Proline, phenylalanine", "Serine, threonine"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Boiling point", "Ignition temperature", "Melting point", "Heat temperature"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["UV rays", "Neutrons", "X-rays, gamma rays, and electron beams", "Infrared rays"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Brucellosis", "Hepatitis A virus", "Tuberculosis", "Salmonellosis"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["In assessment of hormonal activity", "All of the above", "Malignancy", "Evaluation of endocrine disorder"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["15 KHz", "20 KHz", "30 KHz", "50 KHz"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Human papilloma virus", "Treponema pallidum", "Neisseria gonorrhoeae", "Human immunodeficiency virus"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Weight of non-metals", "Age of fossils", "Volume of liquids", "Age of plastic"],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ["Knee joint", "Hip joint", "Pelvis", "Elbow joint"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Inside the lead apron chest level", "The back side at the shoulder position", "Outside the lead apron collar position", "Outside the lead apron stomach position"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Medial wall of the third part of duodenum", "Medial wall of the second part of duodenum", "Lateral wall of the second part of duodenum", "Medial wall of the first part of duodenum"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["More uniform density", "Greater area of lung structures shown", "Increased contrast", "Greater magnification"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Immobilizing the patient", "Retaining the contrast medium in the collecting system", "Aiding in the excretion process", "Preventing the patient from breathing during exposure"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Intravenous pyelogram", "Retrograde pyelogram", "Cystogram", "Intravenous urogram"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["1-20 Hz", "10-20 KHz", "1-20 MHz", "10-20 MHz"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Sound waves", "Radio waves", "X-rays", "Ultraviolet"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Femoral arteries", "Common iliac arteries", "Popliteal arteries", "Tibial arteries"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["KUB Radiography", "Myelography", "Thermography", "Xeroradiography"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Silver iodide", "Both Silver bromide and Silver iodide", "Silver bromide", "Neither Silver bromide nor Silver iodide"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Lumbo-sacral spine", "Cervico-thoracic junction", "Humerus", "Coccyx"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Base of skull", "Paranasal sinuses", "Orbits", "Mastoid bones"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Base of lung", "Apices of lung", "Mediastinum", "Diaphragm"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Nuclear medical imaging", "MRI", "X-Ray", "CT"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["AP view", "Both Lateral decubitus and Erect views", "Lateral decubitus view", "Erect view"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Beta rays", "Gamma rays", "Alpha rays", "X-rays"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["1 and 3 only", "2 and 3 only", "1 and 2 only", "3 only"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Zinc cadmium sulphide", "Cesium iodide", "Gadolinium oxysulphide", "Calcium tungstate"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Frontal", "Sphenoid", "Ethmoid", "Maxillary"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Erect", "Trendelenburg", "Recumbent", "Fowler"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["1, 2, and 3", "2 and 3 only", "1 and 2 only", "1 and 3 only"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Atelectasis", "Emphysema", "Pneumonia", "Empyema"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["25 degrees towards the head", "10 degrees towards the feet", "25 degrees towards the feet", "10 degrees towards the head"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["1 only", "1, 2, and 3", "1 and 2 only", "1 and 3 only"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["5 mAs, 85 kV, 48-inches SID", "10 mAs, 74 kV, 36-inches SID", "10 mAs, 74 kV, 44-inches SID", "5 mAs, 85 kV, 40-inches SID"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Focal spot size", "Film-screen contact", "Screen lag", "Screen speed"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Blackening", "Resolution", "Brightness", "Gray scale"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Pneumoperitoneum", "Ascites", "Obstructed bowel", "Renal colic"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Width of the lead strip", "Number of lead strips per inch", "Distance between the lead strips", "Angle of the lead strip"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["1 only", "1 and 2 only", "3 only", "2 and 3"],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: ["Towards the medial side", "Caudally", "Cranially", "Towards the lateral side"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Modified Cysto Urethrogram", "Micturating Cysto Urethrography", "Micturating Cysto Ureterography", "Micturating Cysto Urinography"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Whole-body dose", "Somatic and genetic effects", "Localized organ dose", "Genetic effects only"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["4.5-6 mg/100 ml", "0.6-1.5 mg/100 ml", "8-25 mg/100 ml", "Up to 50 mg/100 ml"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Pyelogram", "Nephrogram", "Ureterogram", "Venogram"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Reflected", "Transmitted", "All of the above (reflected, absorbed, transmitted)", "Absorbed"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Matrix size", "KV", "Tissue density", "Slice thickness"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Nickel-Tin alloy", "Tungsten-Rhenium alloy", "Tungsten-Nickel alloy", "Tungsten-Aluminum alloy"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Reduces patient dose", "Reduces blurring", "Decreases spatial resolution", "Increases loading of X-ray tube"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["10-15°C", "16-22°C", "23-27°C", "28-32°C"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Silver Chloride", "Silver Bromide", "Silver Iodide", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Bronchoscopy", "Cystography", "Bronchography", "Urography"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["36 inches", "60 inches", "72 inches", "40 inches"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Fistulogram", "Sialography", "Ductography", "Sinography"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Base of skull", "Oblique view of mandible", "Petrous portion of temporal bone", "Orbit"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["AP projection", "Water's projection", "Lateral projection", "None of the above"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Talus", "Patella", "Scapula", "Hip joint"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["AP view", "Axial view", "True lateral view", "Oblique view"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Reduce patient motion", "Avoid superimposition on the apices of lung", "Keep mid sagittal plane parallel", "Reduce patient dose"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["The 10 days preceding the menstruation", "The first 10 days following the onset of menstruation", "The first 10 days following the cessation of menstruation", "14 days before menstruation"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Dual foil", "Tri foil", "Single foil", "Quad foil"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Reduced X-ray tube heating", "Increased patient exposure", "Shorter exposure time", "Decreased image contrast"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["The size of the source", "Distance from the source", "Radioactive decay", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Neutral", "Acidic", "Alkaline", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["1 joule/kg", "100 joules/kg", "0.01 Gy", "0.1 Gy"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Thermionic emission", "Heel effect", "Stray radiation", "Tube rating"],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ["Capitulum", "Bicipital groove", "Epicondyles", "Trochlea"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Sagittal", "Axial", "Coronal", "Median sagittal"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["CT scan", "Bone mineral densitometry", "MRI", "Cardiac catheterisation"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q4",
        question: "In IVP, the first film after contrast injection is:",
        options: ["Pyelogram", "Ureterogram", "Nephrogram", "Venogram"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["2-0-2-3 / 2-0-2-3", "2-1-2-3 / 2-1-2-3", "2-1-0-3 / 2-1-2-3", "2-1-2-2 / 2-1-2-2"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Intraoral paraapex", "Interoral para align", "Intraoral periapical", "Interoral periapical"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Bronchi", "Alveoli", "Respiratory bronchiole", "Terminal bronchiole"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Trapezius", "Latissimus dorsi", "Levator scapulae", "Rhomboids major"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Air", "Medium (jelly, oil etc.)", "Vacuum", "Gas"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Different atomic number but same mass number", "Same atomic number but different mass number", "Equal number of protons and electrons", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q14",
        question: "When X-ray beam falls on the body, they are:",
        options: ["Reflected", "Absorbed", "All of the above", "Transmitted"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["10 mm of Hg", "10⁻³ mm of Hg", "10⁻² mm of Hg", "None"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Conduction and convection", "Conduction, convection and radiation", "Conduction and radiation", "Convection and radiation"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["mA", "KVP", "Exposure time", "Focus film distance"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Roentgen", "Milli Sievert", "Rad", "Curie"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["20000-50000 Hz", "500001 MHz", "1 MHz-20 MHz", "20 MHz+"],
        correctAnswer: 2,
      ...
      },
      {
        id: "p3_q20",
        question: "Anode in rotating anode X-ray tube is made of:",
        options: ["Nickel-Tin alloy", "Tungsten-Rhenium alloy", "Tungsten-Nickel alloy", "Tungsten-Aluminium alloy"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Improved spatial resolution", "Reduced patient dose", "All of the above", "Improved contrast resolution"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Wavelength and angle of scattering", "Frequency and atomic number", "Wavelength and intensity of X-ray", "Frequency and applied voltage"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["0.05 mm", "0.75 mm", "0.25 mm", "1 mm"],
        correctAnswer: 2,
      ...
      },
      {
        id: "p3_q25",
        question: "Ideal temperature of the dark room is:",
        options: ["10-15°C", "23-27°C", "16-22°C", "28-32°C"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Mammography", "Ultrasound", "Both Mammography and Ultrasound", "None"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Gray", "Amber", "Green", "White"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Silver Chloride", "Silver Iodide", "Silver Bromide", "None of the above"],
        correctAnswer: 2,
      ...
      },
      {
        id: "p3_q29",
        question: "Fixing solutions used in radiography are:",
        options: ["Acidic", "Alkaline", "Neutral", "None of the above"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["50-55°C", "35-40°C", "18-20°C", "25-30°C"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["PA view", "PA view with ulnar deviation", "Lateral view", "PA view with radial deviation"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Axial view of shoulder", "PA view of shoulder", "Tangential projection", "Lateral view"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Pelvis", "Hip joint and upper third of Femur", "Sacro-Iliac joint", "Chest region"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q34",
        question: "The specialized radiological examination of lungs and bronchial tree using an opaque contrast medium is called:",
        options: ["Cystography", "Bronchography", "Bronchoscopy", "Urography"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q35",
        question: "To decrease the magnification of the heart in PA view of chest, the film focal distance is kept at:",
        options: ["40 inches", "72 inches", "60 inches", "36 inches"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Sinography", "Sialography", "Fistulogram", "Ductography"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q37",
        question: "Stenver's projection view is basically done for:",
        options: ["Orbit", "Petrous portion of temporal bone", "Base of skull", "Oblique view of mandible"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Flat bone", "Sesamoid bone", "Long bone", "Irregular bone"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q39",
        question: "Which view of the nasal bone shows bony nasal septum best?",
        options: ["AP projection", "Lateral projection", "Water's projection", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q40",
        question: "Skyline view is used for:",
        options: ["Patella", "Talus", "Scapula", "Hip joint"],
        correctAnswer: 0,
      ...
      },
      {
        id: "p3_q41",
        question: "What position of the elbow best demonstrates the Olecranon process?",
        options: ["AP view", "True lateral view", "Axial view", "Oblique view"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Full inspiration", "Full expiration", "Rapid breathing", "Shallow breathing"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Left lateral decubitus", "Right lateral decubitus", "Ventral decubitus", "Dorsal decubitus"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q44",
        question: "The patient's chin should be elevated during chest radiography to:",
        options: ["Keep mid sagittal plane parallel", "Avoid superimposition on the apices", "Reduce patient motion", "Reduce patient dose"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["14 days before menstruation", "The first 10 days following the onset of menstruation", "The first 10 days following the cessation of menstruation", "The 10 days preceding the onset of menstruation"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Induction", "Thermoluminescence", "Thermionic emission", "Photographic effect"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q48",
        question: "MCU stands for:",
        options: ["Modified Cysto Urethrogram", "Micturating Cysto Urethrography", "Micturating Cysto Urinography", "Micturating Cysto Ureterography"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Anode angle", "Focal spot size", "Cathode temperature", "Exposure time"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Reduced X-ray tube heating", "Increased patient exposure", "Shorter exposure times", "Decreased area contrast"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Frontal bone", "Temporal bone", "Occipital bone", "Sphenoid bone"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Bremsstrahlung processes", "Both Bremsstrahlung and K-shell emission", "K-shell emission processes", "Neither"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Produces less susceptibility artifacts", "Increases the signal to noise ratio", "Reduces the risk of tissue heating", "Reduces the danger from metallic projectiles"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Distance from the source", "Radioactive decay", "The size of the source", "None of the above"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["Amplitude (energy)", "Frequency", "Physical size", "Intensity"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Visibility of large, low contrast objects", "Visibility of anatomical detail", "Visibility of noisy images", "Visibility of soft tissues"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Photon energy", "Velocity", "Wavelength", "Frequency"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Small ionization chamber", "Geiger counter", "Large ionization chamber", "Scintillation detector"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Structure mottle", "Quantum mottle", "Random mottle", "Graininess"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["5 mSv", "50 mSv", "20 mSv", "2 mSv"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Sieverts", "Grays", "Man Sieverts", "Coulombs"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q63",
        question: "One rad is equal to the absorption of:",
        options: ["100 joules/kg", "0.01 Gy", "1 joule/kg", "0.1 Gy"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["The gamma ray is scattered", "All the gamma ray energy is transferred to the photoelectron", "Fluorescent X-ray emission never results", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q65",
        question: "The intensity of the X-ray beam that leaves the X-ray tube is not uniform throughout all portions of the beam. This is called:",
        options: ["Thermionic emission", "Stray radiation", "Heel effect", "Tube rating"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Very hard", "High thermal conductivity", "Poor heat dissipation", "None of the above"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Distance", "Dosimeter", "Time", "Shielding"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["X-ray table", "Film cassette", "Grids", "All of these"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Boro glass", "Pyrex glass", "Aluminium", "Beryllium"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Pair production", "Compton scattering", "Pair annihilation", "Photo electric effect"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q71",
        question: "The radiation warning symbol is a black _____ on a yellow background:",
        options: ["Dual foil", "Trifoil", "Quad foil", "Single foil"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["The back side at the shoulder position", "Inside the lead apron chest level", "Outside the lead apron collar position", "Outside the lead apron stomach position"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Roentgen", "Lawrence", "Bergonie", "Kerst"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Exposure output", "kV", "HVL", "Patient exposure"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["Matrix size", "Tissue density", "kV", "Slice thickness"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ["Focal spot size", "mA", "kV", "Exposure time"],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ["An alpha particle", "A beta plus particle", "A beta minus particle", "A proton and a neutron"],
        correctAnswer: 1,
      ...
      },
      {
        id: "p3_q79",
        question: "In order to better visualize joint space in AP view of knee joint, the tube is angled 5 to 7 degrees:",
        options: ["Cranially", "Towards medial side", "Caudally", "Towards lateral side"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ["25° towards head", "10° towards feet", "25° towards feet", "10° towards head"],
        correctAnswer: 1,
